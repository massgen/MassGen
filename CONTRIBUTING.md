...
> **Important**: Our next version is v0.0.19. If you want to contribute, please contribute to the `dev/v0.0.19` branch.

1. **Fork the repository** and create a feature branch from `dev/v0.0.19`
