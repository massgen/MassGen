    ...
    if len(agents) == 1 and not use_orchestrator_for_single:
        ...
        if coordination_settings:
            ...
            orchestrator_config.coordination_config = CoordinationConfig(
                ...
                planning_mode_instruction=coordination_settings.get("planning_mode_instruction", "During coordination, describe what you would do without actually executing actions. Only provide concrete implementation details without calling external APIs or tools.")
            )
