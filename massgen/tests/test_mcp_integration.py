    ...
    async def async_test_claude_code_mcp_integration(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            backend = ClaudeCodeBackend(
                cwd=temp_dir,
                mcp_servers=[simple_server_config]
            )
            ...
            try:
                ...
                self.assertGreaterEqual(len(mcp_tools), 3)  # echo, add_numbers, get_current_time
...
if __name__ == "__main__":
    ...
    print("uv run python -m massgen.cli --config massgen/configs/claude_code_simple_mcp.yaml \"Test MCP tools: echo 'hello', add 5+3, get time\"")