...
class ClaudeBackend(LLMBackend):
    ...
    def convert_tools_to_claude_format(self, tools: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def convert_messages_to_claude_format(self, messages: List[Dict[str, Any]]) -> tuple:
    ...
    async def stream_with_tools(self, messages: List[Dict[str, Any]], tools: List[Dict[str, Any]], 
        ...
        try:
            ...
            # Extract parameters
            model = kwargs.get("model", "claude-3-5-haiku-latest")  # Use model that supports code execution
            ...
            async for event in stream:
                try:
                    ...
                    yield StreamChunk(type="error", error=f"Event processing error: {event_error}")
                    continue
