            ...
            if target_format == "chat_completions":
                ...
                for tool in tools:
                    if tool.get("type") == "custom":
                        converted_tools.append({"type": "function", "function": {"name": tool.get("name", ""), "description": tool.get("description", ""), "parameters": tool.get("input_schema", {})}})
                    else:
                        converted_tools.append(tool)
                return converted_tools
            elif target_format == "response_api":
                ...
                for tool in tools:
                    if tool.get("type") == "custom":
                        converted_tools.append({"type": "function", "name": tool.get("name", ""), "description": tool.get("description", ""), "parameters": tool.get("input_schema", {})})
                    else:
                        converted_tools.append(tool)
                return converted_tools
